  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        // When viewport is disabled (dropdown style)
        ...
        // ✅ Αντί για **: ... κάνουμε safe selector για links μέσα στο content
        "[&_[data-slot=navigation-menu-link]]:focus:outline-none " +
          "[&_[data-slot=navigation-menu-link]]:focus:ring-0",
        className
      )}
      {...props}
    />
