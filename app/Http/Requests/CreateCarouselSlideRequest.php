...
/**
 * Validates the create carousel slide form submitted by staff.
 *
 * title is required. description and linked product are optional.
 * Staff may upload a custom image, or the slide may fall back to the
 * linked product image when a linked product exists and already has one.
 */
